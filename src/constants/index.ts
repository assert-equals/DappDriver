...
const DEFAULT_METAMASK_VERSION: string = '11.16.5';
const DEFAULT_METAMASK_FLASK_VERSION: string = '11.16.5';
const DEFAULT_RAINBOW_VERSION: string = '1.4.122';
const DEFAULT_ZERION_VERSION: string = '1.6.1';
const RECOMMENDED_METAMASK_VERSIONS: Range = new Range('>=11.16.5 <11.16.6');
const RECOMMENDED_METAMASK_FLASK_VERSIONS: Range = new Range('>=11.16.5 <11.16.6');
