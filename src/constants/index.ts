...
const DEFAULT_METAMASK_VERSION: string = '11.15.1';
const DEFAULT_METAMASK_FLASK_VERSION: string = '11.15.1';
const DEFAULT_RAINBOW_VERSION: string = '1.4.84';
const DEFAULT_ZERION_VERSION: string = '1.4.0';
const RECOMMENDED_METAMASK_VERSIONS: Range = new Range('>=11.15.0 <11.16.0');
const RECOMMENDED_METAMASK_FLASK_VERSIONS: Range = new Range('>=11.15.0 <11.16.0');
const RECOMMENDED_RAINBOW_VERSIONS: Range = new Range('>=1.4.84 <1.5.0');
