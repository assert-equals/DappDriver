...
export const DEFAULT_METAMASK_VERSION: string = '11.16.16';
export const DEFAULT_METAMASK_FLASK_VERSION: string = '11.16.16';
export const DEFAULT_RAINBOW_VERSION: string = '1.5.14';
export const DEFAULT_ZERION_VERSION: string = '1.9.1';
export const RECOMMENDED_METAMASK_VERSIONS: Range = new Range('>=11.16.16 <12.0.0');
export const RECOMMENDED_METAMASK_FLASK_VERSIONS: Range = new Range('>=11.16.16 <12.0.0');
export const RECOMMENDED_RAINBOW_VERSIONS: Range = new Range('>=1.5.14 <1.6.0');
export const RECOMMENDED_ZERION_VERSIONS: Range = new Range('>=1.9.1 <2.0.0');
