...
const DEFAULT_METAMASK_VERSION: string = '11.16.12';
const DEFAULT_METAMASK_FLASK_VERSION: string = '11.16.12';
const DEFAULT_RAINBOW_VERSION: string = '1.4.122';
const DEFAULT_ZERION_VERSION: string = '1.7.1';
const RECOMMENDED_METAMASK_VERSIONS: Range = new Range('>=11.16.12 <11.17.0');
const RECOMMENDED_METAMASK_FLASK_VERSIONS: Range = new Range('>=11.16.12 <11.17.0');
const RECOMMENDED_RAINBOW_VERSIONS: Range = new Range('>=1.4.122 <1.5.0');
const RECOMMENDED_ZERION_VERSIONS: Range = new Range('>=1.7.1 <1.8.0');
