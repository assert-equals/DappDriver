...
export const DEFAULT_METAMASK_VERSION: string = '12.2.4';
...
export const RECOMMENDED_METAMASK_VERSIONS: Range = new Range('>=12.2.4 <13.0.0');
export const RECOMMENDED_METAMASK_FLASK_VERSIONS: Range = new Range('>=12.2.4 <13.0.0');
