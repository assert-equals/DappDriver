...
export const DEFAULT_METAMASK_VERSION: string = '12.0.1';
export const DEFAULT_METAMASK_FLASK_VERSION: string = '12.0.1';
export const DEFAULT_RAINBOW_VERSION: string = '1.5.23';
export const DEFAULT_ZERION_VERSION: string = '1.10.0';
export const RECOMMENDED_METAMASK_VERSIONS: Range = new Range('>=12.0.1 <13.0.0');
export const RECOMMENDED_METAMASK_FLASK_VERSIONS: Range = new Range('>=12.0.1 <13.0.0');
