...
export const DEFAULT_METAMASK_VERSION: string = '12.6.0';
export const DEFAULT_METAMASK_FLASK_VERSION: string = '12.6.0';
export const DEFAULT_RAINBOW_VERSION: string = '1.5.58';
export const DEFAULT_ZERION_VERSION: string = '1.15.1';
export const RECOMMENDED_METAMASK_VERSIONS: Range = new Range('>=12.6.0 <13.0.0');
export const RECOMMENDED_METAMASK_FLASK_VERSIONS: Range = new Range('>=12.6.0 <13.0.0');
export const RECOMMENDED_RAINBOW_VERSIONS: Range = new Range('>=1.5.58 <1.6.0');
export const RECOMMENDED_ZERION_VERSIONS: Range = new Range('>=1.15.1 <2.0.0');
